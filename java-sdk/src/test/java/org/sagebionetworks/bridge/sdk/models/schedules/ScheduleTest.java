...
public class ScheduleTest {
    ...
    public void canSerializeDeserializeSchedule() throws Exception {
        ...
        String string = BridgeUtils.getMapper().writeValueAsString(schedule);
        schedule = BridgeUtils.getMapper().readValue(string, Schedule.class);
    ...
    public void activitiesDeserializerHrefs() throws Exception {
        Schedule schedule = BridgeUtils.getMapper().readValue("{\"label\":\"label\",\"scheduleType\":\"recurring\",\"cronTrigger\":\"0 0 8 ? * TUE *\",\"eventId\":\"eventId\",\"activities\":[{\"label\":\"label\",\"labelDetail\":\"labelDetail\",\"survey\":{\"identifier\":\"identifier\",\"guid\":\"AAA\",\"href\":\"https://webservices.sagebase.org/s3/surveys/AAA/revisions/published\"},\"activityType\":\"survey\"}],\"times\":[\"10:10:00.000\",\"14:00:00.000\"],\"startsOn\":\"2015-02-02T10:10:10.000Z\",\"endsOn\":\"2015-01-01T10:10:10.000Z\",\"expires\":\"P2D\",\"delay\":\"P1D\",\"interval\":\"P3D\"}", Schedule.class);
