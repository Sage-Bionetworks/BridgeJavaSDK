...
final class UserSession {
    ...
    @JsonCreator
    private UserSession(@JsonProperty("username") String username, @JsonProperty("sessionToken") String sessionToken, @JsonProperty("authenticated") boolean authenticated, @JsonProperty("consented") boolean consented, @JsonProperty("dataSharing") boolean dataSharing) {
    ...
    public static UserSession valueOf(JsonNode json) {
        return mapper.convertValue(json, UserSession.class);
    }
    
    public static UserSession valueOf(String json) {
    ...
    static UserSession signOut(UserSession session) {
        return new UserSession(session.getUsername(), null, false, session.isConsented(), session.isDataSharing());
    }
