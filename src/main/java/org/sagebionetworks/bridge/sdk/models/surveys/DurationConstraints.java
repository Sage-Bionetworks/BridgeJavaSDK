...
public final class DurationConstraints extends NumericalConstraints {
    ...
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof DurationConstraints))
            return false;
        DurationConstraints other = (DurationConstraints) obj;
