...
public class AuthenticationHandlerIntegrationTest {
  ...
  public void before() {
    ...
    OkHttpClient authedHttpClient = new OkHttpClient.Builder().authenticator(authenticationHandler)
  ...
  public void testReauthOnLogout() throws Exception {
    UploadRequest dummyUploadRequest = new UploadRequest().contentLength(1)
                                                          .contentMd5("hash")
                                                          .name("name")
                                                          .contentType("type");
    ...
    // expires token
    AuthenticationApi authenticatedAuthService = bridgeAuthenticatedRetrofit.create(
